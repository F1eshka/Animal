...
int main()
{
    Bison* bison = new Bison(100, true);
    Lion* lion = new Lion(200);

    Africa a;
    a.AddHerbivore(bison);
    a.AddCarnivore(lion);

    WildeBeest* wildebeest = new WildeBeest(70, true);
    Wolf* wolf = new Wolf(100);

    NortAmerica n;
    n.AddHerbivore(wildebeest);
    n.AddCarnivore(wolf);
